...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or Config.commonmenu, Texture = TextureName or Config.interaction_bgd, Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
RageUI.Acces = function()
    return acces
end


RageUI.SetAcces = function(boolean)
    acces = boolean
end